...
const HAVE_NOT_PERMISSION_ACCESS_DOJO = {
  ...
  message: 'User does not have permission access to this website.'
};
...
const DISABLED_USER = {
  code: INVALID_CODE,
  message: 'Your account has been disabled, please contact your system administrator for more information'
};
...
const INVALID_USER = {code: INVALID_CODE, message: 'User name or password is incorrect!'};


function getResponseMessage(model, action) {
  return {code: SUCCESS_CODE, message: action + " " + model + " is successful."}
}
