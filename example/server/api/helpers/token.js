...
const {HAVE_NOT_PERMISSION, TOKEN_INVALID, NOT_PERMISSION_CODE, INVALID_CODE} = require("./exception");
const ZALOPAY_DOJO_PRIVATE_KEY = "ZALOPAYDOJO_PRIVATE_KEY";
const ROLE = {
  // Admin
  1: ["userQuery", "userCreate", "userUpdate", "userRemove", "questionCreate", "questionQuery", "questionRemove"],
